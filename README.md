The repo contains a set of Python scripts that do various things related to my senior thesis. To run them, you'll need to install `docplex` for Python 3.10.11; the instructions to do this can be found online. You will also need `matplotlib` and `sqlite3`, but these and any other dependencies can be installed as usual with the package manager. 
